...
class AppController extends Controller {
	public $components = array('RequestHandler', 'Session', 'VisualCaptcha');
	public $theme = 'Alpha';
	...
	protected function themeLogic(ARRAY $data){
		//json by time - {"c":"default","a":"t","theme":["alpha","beta"],"v":"23:56"}
		//json by percentage -  {"c":"default","a":"s","theme":["alpha","beta"],"v":["50","50"]}
