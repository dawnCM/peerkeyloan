              ...
              <div class="tab-content <?php echo $this->Session->read('Application.AppType');?>">
                  <div class="tab-pane tab1" id="tab1">
                    ...
                    <div class="row">
						...
						<input name="Email" type="text" class="form-control" id="Email" tabindex="7" size="20" maxlength="50"  value="<?php echo $this->Session->read('Application.Email'); ?>" placeholder="Email" 
						data-parsley-required="true" 
				...
				<div class="tab-pane tab3" id="tab3">
                    ...
                    <div class="row">
                    	...
                    	<div class="col-sm-4">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control"	name="MonthlyNetIncome" tabindex="9" id="MonthlyNetIncome" value="<?php echo $this->Session->read('Application.MonthlyNetIncome'); ?>" data-parsley-required="true"  maxlength="5" tabindex="13"  
								data-parsley-required="true" 
								data-parsley-type="digits" 
								data-parsley-length="[1,5]"
								data-parsley-group="step3"/>
                  ...
                  <div class="tab-pane tab4" id="tab4">
                   ...
                   <div class="row">
                    	...
                    	<div class="col-sm-4"><a href="<?php echo Configure::read('Global.NoCheckingUrl'); ?>" target="_blank"><?php echo $this->Html->image('no_bank_acct.png', array('alt'=>'No Bank Account', 'class'=>'img-responsive', 'width'=>'130', 'height'=>'30', 'id'=>'no_bank')); ?></a></div>
                    </div>
                  ...
                  <div class="tab-pane tab6" id="tab6">
                    ...
                    <div id="CoAppAddress" style="display:none;" class="row">
                        ...
                        <div class="col-sm-2">
							...
							<input name="CoZip" type="text" class="form-control" id="CoZip" tabindex="14" maxlength="5" value="<?php echo $this->Session->read('Application.CoZip'); ?>" placeholder="Co-Applicant Zip Code" 
							data-parsley-required="true" 
							data-parsley-pattern="/^[0-9]{5}?$/" 
							data-parsley-group="step6"/>
                        </div>
