					...
					<div class="cm_masthd_contentbox_row">
						<div id="cm_masthd_lcol">
							<div id="cm_masthd_lcol_title">
								Loans for<br /><strong><span class="highlight">ALL CREDIT TYPES</span></strong>
							</div>
							<div class="cm_masthd_lcol_loantype">
								<strong><span class="highlight">Personal Loans</span></strong><br />up to
							</div>
							<div class="cm_masthd_lcol_loanamt">$25,000</div>
						</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<div class="input-group">
											...
											<input type="text" class="form-control"	name="MonthlyNetIncome" id="MonthlyNetIncome" value="<?php echo $this->Session->read('Application.MonthlyNetIncome'); ?>" placeholder="Income" maxlength="5" tabindex="4"
											data-parsley-required="true" 
