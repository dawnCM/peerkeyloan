						...
						<div id="cm_masthd_rcol">
							<form class="form-horizontal" role="form" id="LeadInForm" action="/application" method="post">
								<div class="form-group">
									<label for="LoanPurpose" class="col-sm-5 control-label">Intended Use:</label>
									<div class="col-sm-6">
								...
								<div class="form-group">
									<div class="col-sm-12">
										<div class="ckbox ckbox-success">
											<input type="checkbox" value="true" id="Agree" tabindex="5" name="Agree" data-parsley-required="true" <?php if($this->Session->read('Application.Agree')=="true"){ echo "checked";} ?> /> <label
