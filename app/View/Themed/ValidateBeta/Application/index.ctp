<div id="p2_sec01_wrap">
	<div class="container">
    	<div class="row">
        	<div class="col-sm-12">
            	<div id="p2_sec01_headline">Our network of lenders are <strong>online now</strong> - <strong>ready to approve you</strong></div>
            </div>
        </div>
    </div>
</div>
    	...
    	<div class="col-sm-12">
          <form method="post" id="basicWizard" class="panel-wizard">
              ...
              <div class="tab-content <?php echo $this->Session->read('Application.AppType');?>">
                  <div class="tab-pane tab1" id="tab1">
                    ...
                    <div class="row">
						...
						<input data-trigger="focus" data-container="body" data-toggle="popover-info" data-placement="top" data-title="Email Validation" data-content="To better protect your identity, we will send a validation code to the email address you provide." name="Email" type="email" class="form-control" id="Email" tabindex="7" size="20" maxlength="50"  value="<?php echo $this->Session->read('Application.Email'); ?>" placeholder="Email" 
						data-parsley-required="true" 
                  ...
                  <div class="tab-pane tab7" id="tab7">
                    ...
                    <div class="row">
                    	...
                    	<div class="col-sm-4">
						<label for="Email">Email:</label>
						<input name="Email" data-container="body" data-toggle="popover-info" data-placement="top" data-title="Email Validation" data-content="To better protect your identity, we will send a validation code to the email address you provide." type="email" class="form-control" id="Email" tabindex="6" size="20" maxlength="50"  value="<?php echo $this->Session->read('Application.Email'); ?>" placeholder="Email" 
						data-parsley-required="true" 
						data-parsley-pattern="/^[\w-]+(\.[\w-]+)*@([a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*?\.[a-zA-Z]{2,6}|(\d{1,3}\.){3}\d{1,3})(:\d{4})?$/" 
						data-parsley-group="step1"/>
                        </div>
                  ...
                  <div class="tab-pane tab2" id="tab2">
                    ...
                    <div class="row">
						...
						<input name="Ssn" type="text" class="form-control" id="Ssn" tabindex="2" placeholder="SSN" value="<?php echo $this->Session->read('Application.Ssn'); ?>" 
						data-parsley-required="true"
                    ...
                    <div class="row">
                    	...
                    	<div class="col-sm-4">
                    		<label for="ValidateEmail">Validation Code <a href="https://global.leadstudio.com/validation" data-title="Validation Code" data-width="325" data-toggle="lightbox" data-gallery="remoteload">(what is this?)</a></label>
				...
				<div class="tab-pane tab3" id="tab3">
                  ...
                  <div class="tab-pane tab6" id="tab6">
                    ...
                    <div class="row">
						...
						<input name="CoSsn" type="text" class="form-control" id="CoSsn" tabindex="4"  placeholder="Co-Applicant SSN" value="<?php echo $this->Session->read('Application.CoSsn'); ?>" 
						data-parsley-required="true"
						data-parsley-pattern="/^(\d{3})-(\d{2})-(\d{4})$/" 
						data-parsley-group="step6"/>
                        </div>
              ...
              <ul class="list-unstyled wizard">
                  <li class="pull-left previous"><button type="button" class="btn btn-default btnprev">Previous</button></li>
                  <li class="pull-right next"><button tabindex="20" type="button" class="btn btn-primary btnnext">Next</button></li>
              </ul>
