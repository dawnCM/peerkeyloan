 ...
 */
Configure::write('Global.Domain','http://peerkeyloan.xyz.local');
...
Configure::write('Offers.Organic.OfferId', '43');
Configure::write('Offers.Organic.CampaignId', '147');
Configure::write('Offers.Organic.CreativeId', '210');
